            ...
            {!currentSeller ? (
              <div className="pt-20">
                ...
                <div className="space-y-4">
                  <input type="text" placeholder="ЛОГИН" className="w-full bg-zinc-900 p-6 rounded-2xl font-bold text-[10px] outline-none border border-zinc-800" onChange={e => setSellerAuth({...sellerAuth, login: e.target.value})}/>
                  <input type="password" placeholder="ПАРОЛЬ" className="w-full bg-zinc-900 p-6 rounded-2xl font-bold text-[10px] outline-none border border-zinc-800" onChange={e => setSellerAuth({...sellerAuth, pass: e.target.value})}/>
